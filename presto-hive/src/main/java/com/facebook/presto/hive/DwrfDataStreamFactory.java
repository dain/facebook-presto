...
import static com.facebook.presto.hive.OrcDataStreamFactory.createOrcDataStream;

public class DwrfDataStreamFactory
        implements HiveDataStreamFactory
{
    private final boolean enabled;

    @Inject
    public DwrfDataStreamFactory(HiveClientConfig config)
    {
        //noinspection deprecation
        this(config.isOrcOptimizedReaderEnabled());
    }

    public DwrfDataStreamFactory()
    {
        this(true);
    }

    public DwrfDataStreamFactory(boolean enabled)
    {
