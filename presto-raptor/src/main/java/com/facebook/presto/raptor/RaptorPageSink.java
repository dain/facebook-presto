        ...
        implements ConnectorPageSink
{
    ...
    private class BucketedPageWriter
            implements PageWriter
    {
        private final ConnectorBucketFunction bucketFunction;
        ...
        public void appendPage(Page page)
        {
            ...
            for (int position = 0; position < page.getPositionCount(); position++) {
                ...
                if (store == null) {
                    ...
                    store = new PageStore(new PageBuilder(columnTypes), buffer);
    ...
    private static class PageStore
    {
        ...
        public PageStore(PageBuilder pageBuilder, PageBuffer pageBuffer)
        {
