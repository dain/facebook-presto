        ...
        implements ConnectorMetadata
{
    ...
    private Distribution getOrCreateDistribution(String name, List<Type> columnTypes, int bucketCount)
    {
        ...
        if (distribution == null) {
            throw new PrestoException(INTERNAL_ERROR, "Distribution does not exist after insert");
        }
        return distribution;
    }
    ...
    private static List<RaptorColumnHandle> getBucketColumnHandles(List<String> sortColumns, Map<String, RaptorColumnHandle> columnHandleMap)
    {
        ...
        for (String column : sortColumns) {
            ...
            sortColumnHandles.add(columnHandleMap.get(column));
        }
