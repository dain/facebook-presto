...
import com.facebook.presto.execution.buffer.LazyBuffer;
...
public class SqlTask
{
            ...
            DataSize maxBufferSize)
    {
        ...
        outputBuffer = new LazyBuffer(taskId, taskInstanceId, taskNotificationExecutor, maxBufferSize, new UpdateSystemMemory(queryContext));
