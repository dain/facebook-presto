        ...
        implements Operator
{
    ...
    private final FilterAndProject processor;
    private Page currentPage;
    private int currentPosition;
    private boolean finishing;

    public FilterAndProjectOperator(OperatorContext operatorContext, Iterable<? extends Type> types, FilterAndProject processor)
    {
            ...
            implements OperatorFactory
    {
        ...
        public FilterAndProjectOperatorFactory(int operatorId, FilterAndProject processor, List<Type> types)
        {
