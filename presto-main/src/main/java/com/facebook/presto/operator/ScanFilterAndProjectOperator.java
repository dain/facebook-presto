        ...
        implements SourceOperator, Closeable
{
    ...
    private final FilterAndProject cursorProcessor;
    private final FilterAndProject pageProcessor;
    ...
    protected ScanFilterAndProjectOperator(
            ...
            FilterAndProject cursorProcessor,
            FilterAndProject pageProcessor,
    ...
    public Page getOutput()
    {
        if (!finishing) {
            if (cursor != null) {
                int rowsProcessed = cursorProcessor.process(operatorContext.getSession(), cursor, 0, 16384, pageBuilder);
