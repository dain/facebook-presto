...
public class JoinToDistinctOperatorFactory
        implements JoinOperatorFactory
{
    ...
    public JoinToDistinctOperatorFactory(int operatorId,
    ...
    private JoinToDistinctOperatorFactory(JoinToDistinctOperatorFactory other)
    {
    ...
    public Operator createOperator(DriverContext driverContext)
    {
        ...
        referenceCount.retain();
        return new JoinToDistinctOperator(
                operatorContext,
                probeTypes,
                buildTypes,
                joinType,
    ...
    {
        return new JoinToDistinctOperatorFactory(this);
    }
