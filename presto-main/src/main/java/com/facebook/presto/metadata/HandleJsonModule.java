        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        jsonBinder(binder).addModuleBinding().to(DistributionHandleJacksonModule.class);
        jsonBinder(binder).addModuleBinding().to(PartitionFunctionHandleJacksonModule.class);
