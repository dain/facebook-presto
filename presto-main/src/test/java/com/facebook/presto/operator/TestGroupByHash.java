...
public class TestGroupByHash
{
    ...
    public void testAddPage()
            throws Exception
    {
        GroupByHash groupByHash = createGroupByHash(TEST_SESSION, ImmutableList.of(BIGINT), new int[] {0}, Optional.empty(), Optional.of(1), 100);
    ...
    public void testTypes()
            throws Exception
    {
        GroupByHash groupByHash = createGroupByHash(TEST_SESSION, ImmutableList.of(VARCHAR), new int[] {0}, Optional.empty(), Optional.of(1), 100);
            ...
            throws Exception
    {
        ...
        GroupByHash groupByHash = createGroupByHash(TEST_SESSION, ImmutableList.of(DOUBLE), new int[] {0}, Optional.empty(), Optional.of(1), 100);
        groupByHash.getGroupIds(new Page(valuesBlock, hashBlock));
            ...
            throws Exception
    {
        ...
        GroupByHash groupByHash = createGroupByHash(TEST_SESSION, ImmutableList.of(DOUBLE, VARCHAR), hashChannels, Optional.empty(), Optional.of(2), 100);
            ...
            throws Exception
    {
        ...
        GroupByHash groupByHash = createGroupByHash(TEST_SESSION, ImmutableList.of(VARCHAR), new int[] {0}, Optional.empty(), Optional.of(1), 4);
        groupByHash.getGroupIds(new Page(valuesBlock, hashBlock));
