...
import com.facebook.presto.execution.scheduler.HashOutputBufferManager.HashPagePartitionFunctionGenerator;
...
public class TestHashOutputBufferManager
{
    ...
    private static final HashPagePartitionFunctionGenerator PARTITION_FUNCTION_GENERATOR = new HashPagePartitionFunctionGenerator(PARTITION_CHANNELS, HASH_CHANNEL, TYPES);
            ...
            throws Exception
    {
        ...
        HashOutputBufferManager hashOutputBufferManager = new HashOutputBufferManager(outputBufferTarget::set, PARTITION_FUNCTION_GENERATOR);
        ...
        assertEquals(buffers.get(new TaskId(STAGE_ID, "0")), new HashPagePartitionFunction(0, 3, PARTITION_CHANNELS, HASH_CHANNEL, TYPES));
        assertEquals(buffers.get(new TaskId(STAGE_ID, "1")), new HashPagePartitionFunction(1, 3, PARTITION_CHANNELS, HASH_CHANNEL, TYPES));
        assertEquals(buffers.get(new TaskId(STAGE_ID, "2")), new HashPagePartitionFunction(2, 3, PARTITION_CHANNELS, HASH_CHANNEL, TYPES));
