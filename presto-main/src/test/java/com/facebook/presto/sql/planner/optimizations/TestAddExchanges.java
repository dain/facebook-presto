...
import static com.facebook.presto.sql.planner.optimizations.ActualProperties.Global.hashDistributed;
import static com.facebook.presto.sql.planner.optimizations.ActualProperties.Global.partitioned;
...
public class TestAddExchanges
{
            ...
            throws Exception
    {
        ...
        Set<Symbol> columns = ImmutableSet.of(symbol("a"));
        List<ActualProperties> input = ImmutableList.<ActualProperties>builder()
                .add(builder()
                        .global(partitioned(columns))
                        .build())
                .add(builder()
                ...
                .add(builder()
                        ...
                        .build())
                .add(builder()
                        .global(hashDistributed(ImmutableList.of(symbol("a"))))
                        .build())
                .add(builder()
                        .global(partitioned(singlePartition()))
            ...
            throws Exception
    {
        ...
        List<ActualProperties> input = ImmutableList.<ActualProperties>builder()
                .add(builder()
                        .global(partitioned(ImmutableSet.of(symbol("a"))))
                        .build())
                .add(builder()
                        .global(undistributed())
                        .build())
